        ...
        <div className="relative bg-white pb-[40px] rounded shadow-lg">
          <div className=" w-full lg:w-[25%] min-h-[200px] bg-[white] shadow-lg rounded-lg px-[10px] relative ">
            ...
            {profileData?._id == userData?._id && (
              <button
                className="min-w-[150px] h-[40px] rounded-full border-2 border-[#2dc0ff] text-[#2dc0ff] my-[20px] flex items-center justify-center gap-[10px] ml-[20px]"
                onClick={() => setEdit(true)}
              >
        ...
        {profileData?.skills?.length > 0 && (
          <div className="w-full min-h-[100px] flex flex-col gap-[10px] justify-center p-[20px]  font-semibold bg-white shadow-lg rounded-lg">
            ...
            <div className="flex flex-wrap justify-start items-center gap-[20px] text-gray-600 p-[20px]">
              ...
              {profileData?._id == userData?._id && (
                <button
                  className="min-w-[150px] h-[40px] rounded-full border-2 border-[#2dc0ff] text-[#2dc0ff]  flex items-center justify-center gap-[10px] ml-[20px]"
                  onClick={() => setEdit(true)}
                >
                  Add Skills
                </button>
