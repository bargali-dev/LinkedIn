...
useEffect(()=>{
  ...
  return (
    <div className="w-screen h-[100vh] bg-[#f0efe7] p-[100px] px-[20px] flex flex-col gap-[40px]">
      <Nav />
      <div className="w-full h-[100px] bg-white rounded-lg shadow-lg flex items-center p-[10px] text-[22px] text-gray-600 justify-between">
      ...
      {notificationData.length > 0 && (
        <div className="w-[100%] max-w-[900px] items-center shadow-lg rounded-lg flex flex-col gap-[20px] min-h-[100px] bg-white h-[100vh] overflow-auto p-[20px] ">
          {notificationData.map((noti, index) => {
            <div
              className=" w-full min-h-[100px] p-[20px] flex items-center justify-between border-b-2 border-b-gray-200"
              key={index}
            >
              <div>
