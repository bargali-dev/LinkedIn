  ...
  return (
    <div className="w-full h-[100vh] fixed top-0 z-[100] flex items-center justify-center ">
      ...
      <div className="w-[90%] max-w-[500px] h-[600px] bg-white relative z-[200] shadow-lg rounded-lg p-[10px] overflow-auto">
        ...
        <div className="w-[20px] h-[20px] bg-[#17c1ff] absolute top-[202px] left-[90px] rounded-full flex items-center justify-center ">
            ...
            {skills && (
              <div className="flex flex-col gap-[10px]">
                {skills.map((skill, index) => (
                  <div
                    key={index}
                    className="w-full h-[40px] border-[1px] border-gray-600 bg-gray-200 rounded-lg p-[10px] flex items-center justify-between"
                  >
                    <span>{skill}</span>
                    <RxCross1
            ...
            {education && (
              <div className="flex flex-col gap-[10px]">
                {education.map((edu, index) => {
                  <div
                    key={index}
                    className="w-full  border-[1px] border-gray-600 bg-gray-200 rounded-lg p-[10px] flex items-center justify-between"
                  >
                    <div>
              ...
              <div className="flex flex-col gap-[10px]">
                {experience.map((exp, index) => {
                  ...
                  >
                    ...
                    <RxCross1
                      className="w-[20px] h-[20px] text-gray-800 font-bold cursor-pointer"
                      onClick={(e) => removeExperience(exp)}
                    />
                  </div>;
                })}
              </div>
